...
<ResponseField name="githubLink" type="Object">
  <Expandable title="GitHub Link">
    <ResponseField name="url" type="string" default="https://github.com/velocitybolt/marly">
      The URL to the GitHub repository.
    </ResponseField>
    <ResponseField name="icon" type="string" default="github">
      Font Awesome icon for GitHub.
    </ResponseField>
    <ResponseField name="stars" type="number" default={15}>
      The number of stars on the GitHub repository.
    </ResponseField>
    <ResponseField name="forks" type="number" default={0}>
      The number of forks on the GitHub repository.
    </ResponseField>
  </Expandable>
</ResponseField>
...
<ResponseField name="topbarCtaButton" type="Call to Action">
  <Expandable title="Topbar Call to Action">
    ...
    <ResponseField name="name" type="string" default="GitHub">
      Text inside the button, showing stars and forks.
    </ResponseField>
    <ResponseField name="icon" type="string" default="github">
      Font Awesome icon for GitHub.
    </ResponseField>
