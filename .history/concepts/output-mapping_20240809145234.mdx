...
In the following case, we want to create an output mapping for an Excel file. Instead of a table name, we will provide the sheet number, and for each column name, the column location. 
```python output_mapping.py
{
